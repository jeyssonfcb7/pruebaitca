...
<html>
	<head>
		<title>Modificar Computadoras</title>
	</head>
<jsp:useBean id="pcm" scope="request" class="javabeans.Computadora" />
<jsp:setProperty name="pcm" property="*"/>
<%if(request.getParameter("id")!=null && request.getParameter("id")!=""){%>
   <jsp:forward page="../controladorpc?operacion=modifica"/>
<%}%>
<body>
<div>
